"""
Storing the different data types values in order and list is changeable in run time. it allows duplicate values.
Values should assignto a variable in square brackets "[]".
...
#Slicing - Getting the required portion of values on the list [1:n-1]
b = name_list[1:5]
print(b)
...
#Inserting value insert (index, "value")
name_list.insert(1, "Some value")
print(name_list)
